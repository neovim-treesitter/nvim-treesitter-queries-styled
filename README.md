# nvim-treesitter-queries-styled

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-styled/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-styled/actions/workflows/validate.yml)

Neovim tree-sitter queries for **styled**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-styled",
...
- [ ] Changes are scoped to `styled` — do not include files for other languages
